      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className='max-w-[80vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          <h2 className="uppercase tracking-widest text-xs text-center text-black max-w-80">
            Showcasing Creativity and Professional Growth
          </h2>

          <TextGenerateEffect
            words="Merging Creativity and Technical Expertise"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl text-black">
            Hi, I&apos;m Ethan Ellerstein, a Software and Cybersecurity Engineer with a passion for writing. Explore my work to see how I merge technical expertise with creativity!
          </p>
